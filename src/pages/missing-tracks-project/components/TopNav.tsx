...
export function TopNav() {
  return (
    <header className='relative z-10 w-full px-4 pt-4 sm:px-6 md:px-8 md:pt-6'>
      <div className='mx-auto flex h-16 max-w-[1120px] items-center justify-between gap-4 rounded-[28px] bg-[rgba(255,255,255,0.01)] px-5 ring-1 ring-white/15 backdrop-blur-[98px] sm:px-7 md:h-[72px] md:px-9'>
        <Link
          to={HOME_PATH}
